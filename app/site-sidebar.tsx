...
export function SiteSidebar({
  ...
  const activeTitle = matchedSection?.title ?? "Workspace";
  ...
  return (
    <aside className="site-sidebar">
      <div className="site-sidebar-card site-sidebar-card-spotlight">
        <p className="site-sidebar-label">Current Area</p>
        <h2 className="site-sidebar-spotlight-title">{activeTitle}</h2>
        <p className="site-sidebar-description" style={{ marginBottom: 0 }}>
          {matchedSection?.description ||
            "Move between creation, publishing, and systems work without leaving the platform shell."}
        </p>
      </div>
